function german_srun_socns_loi1(test_tag)
...
instructTex = Screen('MakeTexture', w.win, imread([defaults.path.stim filesep 'german_loi1_instruction.jpg']));
...
%% End of Test Screen %%
DrawFormattedText(w.win,'Warten Sie mal.','center','center',w.white,defaults.font.wrap);
Screen('Flip', w.win);
ptb_any_key;
